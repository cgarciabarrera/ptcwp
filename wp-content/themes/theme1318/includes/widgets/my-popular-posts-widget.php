                    ...
                    if($posts){
                      foreach($posts as $post){
                        ...
                        <li>
                          ...
                          <?php } ?>
                          <h5><a href="<?php echo $guid; ?>" title="<?php echo $post_title; ?>"><?php echo my_string_limit_char($post_title,9);?>...</a></h5>
                          <div class="excerpt"><?php echo my_string_limit_char($excerpt,46);?>...</div>
                          <a href="<?php echo $guid; ?>"><?php _e('Read more &gt;&gt;','theme1318');?></a>
                        </li>
                    <?php
                        }
                    }
